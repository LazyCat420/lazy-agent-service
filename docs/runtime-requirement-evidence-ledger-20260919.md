...
| HTML Notes executor deduplicates a write after process restart | implementation | Add an isolated persisted executor-idempotency test before relying on restart recovery for mutations. |
